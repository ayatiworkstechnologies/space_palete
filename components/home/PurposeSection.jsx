...
export default function PurposeSection() {
  return (
    <section id="about" className="relative min-h-[58vh] overflow-hidden bg-black px-6 py-20 text-white max-md:flex max-md:min-h-[100svh] max-md:snap-start max-md:snap-always max-md:items-center md:py-28">
